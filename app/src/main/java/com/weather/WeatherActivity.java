...
import com.weather.database.DatabaseQuery;
import com.weather.entity.WeatherObject;
import com.weather.helpers.CustomSharedPreference;
import com.weather.helpers.Helper;
import com.weather.json.FiveDaysForecast;
import com.weather.json.FiveWeathers;
import com.weather.json.Forecast;
import com.weather.json.LocationMapObject;
...
public class WeatherActivity extends AppCompatActivity implements LocationListener {
      ...
      if(isLocationSaved.equals("")){
        ...
        if (locationManager != null && location != null) {
          ...
          apiUrl = "http://api.openweathermap.org/data/2.5/weather?lat="
              ...
              +"&APPID=f3c6d295241f7ec4cb83424efe1feea9&units=metric";
        ...
        if(!TextUtils.isEmpty(city[0])){
          ...
          String url ="http://api.openweathermap.org/data/2.5/weather?q="+city[0]+"&APPID=f3c6d295241f7ec4cb83424efe1feea9&units=metric";
          makeJsonObject(url);
        }
      }
    }
      ...
      if (grantResults[0] == PackageManager.PERMISSION_GRANTED
        ...
        if (ActivityCompat.checkSelfPermission(this,
          ...
          if (locationManager != null) {
            ...
            apiUrl = "http://api.openweathermap.org/data/2.5/weather?lat=51.5074&lon=0.1278&APPID=f3c6d295241f7ec4cb83424efe1feea9&units=metric";
            makeJsonObject(apiUrl);
          }
        }
      }else{
  ...
  private void fiveDaysApiJsonObjectCall(String city){
    String apiUrl = "http://api.openweathermap.org/data/2.5/forecast?q="
        +city+ "&APPID=f3c6d295241f7ec4cb83424efe1feea9&units=metric";
